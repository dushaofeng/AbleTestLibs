...
public class BezierMagicCircle extends View {
    ...
    public BezierMagicCircle(Context context) {
        this(context, null, 0);
    }

    public BezierMagicCircle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezierMagicCircle(Context context, AttributeSet attrs, int defStyleAttr) {
